...
Pe = 0.87;               % Elite ratio for Latent Stress Field 
eta = 0.98;               % Learning rate for the Latent Stress Field 
Cmax = 18;              % Max stress tolerance for Fission Reinjection 

% Dynamic step sizes
alphaD_max = 0.9;        % Maximum drift step size 
alphaR_max = 1.11;        % Maximum rift step size 
